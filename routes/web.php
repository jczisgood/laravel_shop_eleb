...
Route::get('/showa/{event}', 'BusinessUserController@showa')->name('activity.showa');//用户列表
Route::get('/join/{event}', 'BusinessUserController@join')->name('event.join');//用户列表
Route::get('/see/{event}', 'BusinessUserController@see')->name('event.see');//用户列表
